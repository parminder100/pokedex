                    ...
                    <div className="row togge-theme-row align-items-center">
                        ...
                        <div className="col-sm-7 toggle-theme-navbar-bg d-flex justify-content-end">
                            ...
                            <ul className='navbar-list navbar-nav'>
                                ...
                                <Link to="/pokedex"><li className='active nav-item'>Home</li></Link>
                                <Link to="/pokedex/aboutus"><li className='nav-item'>About Us</li></Link>
                                <Link to="/pokedex/movies"><li className='nav-item'>Movies</li></Link>
                                <Link to="/pokedex/news"><li className='nav-item'>News</li></Link>
                                <Link to="/pokedex/contactus"><li className='nav-item'>Contact Us</li></Link>
                            </ul>
                            </div>
                            </nav>
                        </div>
